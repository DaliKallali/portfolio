...
export const HeroSection = () => {
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <p className="mt-4 text-center text-white/60s">
        I specialize in building user-friendly, high-performing web
